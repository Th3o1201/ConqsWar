...
public class Name {
    public static String name () {
        ...
        Random Zahl = new Random(); //Randomizer wird erzeugt
        int ZufallsEintrag = Zahl.nextInt(Namen.length); //Randomizer wird definiert, bekommt einen Wert (int) aus dem Array, definiert dadurch "ZufallsEintrag" mit Zahl zwischen 0 und 7.
